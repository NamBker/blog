...
class Controller_Admin_Posts extends Controller_Admin
{
	...
	public function action_view($id = null)
	{
		...
		$entry = Model_User::find($id_account); // tim ten nguoi dung post trong bang 
		...
		$this->template->content = View::forge('admin/posts/view', $data,false);

		$name = $this->current_user->username;
        $email = $this->current_user->email;
        $user_id = $this->current_user->id;
        $img  = $this->current_user->img;
